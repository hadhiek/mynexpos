...
#line 695 "abstree.y"
	{
                                ...
                                yystack.l_mark[-1].nptr->ptr3 = (struct ASTNode *)Gtemp->paramlist;
                                ...
                                if (indicator == 1)
                                {
                                    yyval.nptr = TreeCreate(yystack.l_mark[-3].nptr->type, NODE_FUNC, yystack.l_mark[-3].nptr->name, NULL, (struct ASTNode *)Gtemp->paramlist, NULL, yystack.l_mark[-1].nptr, NULL);
                                    indicator = 0;
                                }

                                else
                                    yyval.nptr = TreeCreate(yystack.l_mark[-3].nptr->type, NODE_FUNC, yystack.l_mark[-3].nptr->name, NULL, (struct ASTNode *)Gtemp->paramlist, NULL, NULL, yystack.l_mark[-1].nptr);
                            }
#line 2554 "y.tab.c"
break;
case 102:
#line 721 "abstree.y"
	{
                                ...
                                yyval.nptr = TreeCreate(yystack.l_mark[-2].nptr->type, NODE_FUNC, yystack.l_mark[-2].nptr->name, NULL, (struct ASTNode *)Gtemp->paramlist, NULL, NULL, NULL);
                            }
#line 2562 "y.tab.c"
break;
case 103:
...
#line 733 "abstree.y"
	{
	                            type_comp(yystack.l_mark[-1].nptr->type, NULL, '=');
	                            yyval.nptr = TreeCreate(TLookup("boolean"), NODE_DEQ, NULL, NULL, NULL, yystack.l_mark[-1].nptr, yystack.l_mark[0].nptr, NULL);
	        				}
#line 2586 "y.tab.c"
break;
